        ...
        `
            ...
            <div class="container">
                ...
                <div>
                    ...
                    <div id="toolbar"></div>
                    <div id="mini-editor" data-ref="#text" contenteditable="true"></div>
                </div>
            </div>
        ` 
    ,
    ...
    "t-ptr-template":
        `
            ...
            <div class="container">
                ...
                <div id="toolbar">
    			    <button onclick="teian.update.insertAfter((new DOMParser()).parseFromString(teian.frameworkDefinition.biblTemplate, 'application/xml').documentElement.cloneNode(true), this.host.parentNode);">&#xf067;</button>
    			    <button onclick="teian.update.delete(this.host.parentNode);">&#xf2ed;</button>
    		    </div>                
            </div>
        `
    ,
        ...
        `
            ...
            <div class="container">
                ...
                <select data-ref="@type">
                    ...
                    <option label="pronunciation">de pronunțare</option>
                </select>
    ...
    "t-note-template":
        `
            ...
            <div class="container">
                ...
                <div id="mini-editor" contenteditable="true" data-ref="#text"></div>
                <div id="toolbar">
    			    <button onclick="teian.update.insertAfter((new DOMParser()).parseFromString(teian.frameworkDefinition.noteTemplate, 'application/xml').documentElement.cloneNode(true), this.host);">&#xf067;</button>
    			    <button onclick="teian.update.delete(this.host);">&#xf2ed;</button>
			    </div>                
            </div>
       `         
};
...
teian.frameworkDefinition.noteTemplate = `
    <t-note xmlns="http://www.w3.org/1999/xhtml" data-name="note" data-ns="http://www.loc.gov/mods/v3" data-value="" slot="t-note" />
`;
teian.frameworkDefinition.biblTemplate = `
    <t-bibl xmlns="http://www.w3.org/1999/xhtml" data-name="bibl" data-ns="http://www.loc.gov/mods/v3" data-value="" slot="t-bibl">
        <t-ptr xmlns="http://www.w3.org/1999/xhtml" data-name="ptr" data-ns="http://www.loc.gov/mods/v3" data-value="" slot="t-ptr" type="" target="" />
        <t-date xmlns="http://www.w3.org/1999/xhtml" data-name="date" data-ns="http://www.loc.gov/mods/v3" data-value="" slot="t-date" />
        <t-citedrange xmlns="http://www.w3.org/1999/xhtml" data-name="citedRange" data-ns="http://www.loc.gov/mods/v3" data-value="" slot="t-citedrange" />    
    </t-bibl>
`;
...
teian.actions.displaySpecialCharacters = function(element) {
    ...
    const shadowRoot = element.host.shadowRoot;
