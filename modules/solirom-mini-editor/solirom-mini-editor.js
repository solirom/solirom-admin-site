export default class MiniEditorComponent extends HTMLElement {
    constructor() {
        super();
        ...
        this.languages = [
            ["ro-x-accent-upcase-vowels", "ro., lat., maj. acc.", [""]],
...
window.customElements.define("solirom-mini-editor", MiniEditorComponent);
